...
class RoomDetailsPage extends StatefulWidget {
  ...
  const RoomDetailsPage(this.tbContext, this.roomId, {super.key});
...
class _RoomDetailsPageState extends State<RoomDetailsPage> {
  ...
  Widget _buildIfBlock(BuildContext context, Room entity) {
    return Container(
  ...
  Widget _buildThenBlock(BuildContext context, Room entity) {
    return Container(
      decoration: _cardDecoration(),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildPreconditionDisplayArea(Room entity) {
    return Column(
      children: [
        ListTile(
  ...
  Widget _buildSaveButton(BuildContext context, Room entity) {
    return SizedBox(
