...
class HomeAddPage extends StatefulWidget {
  ...
  HomeAddPage(this.tbContext, {super.key});
...
class _HomeAddPageState extends State<HomeAddPage> {
  ...
  Widget _buildIfBlock(BuildContext context, HomeAdd entity) {
    return Container(
  ...
  Widget _buildThenBlock(BuildContext context, HomeAdd entity) {
    return Container(
      decoration: _cardDecoration(),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildPreconditionDisplayArea(HomeAdd entity) {
    return Column(
      children: [
        ListTile(
  ...
  Widget _buildSaveButton(BuildContext context, HomeAdd entity) {
    return SizedBox(
