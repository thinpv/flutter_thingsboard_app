        ...
        if (detected) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: MpColors.red.withValues(alpha: 0.3)),
            ),
            child: const Row(
              children: [
                Icon(Icons.warning_amber_rounded, color: MpColors.red),
                SizedBox(width: 12),
                Expanded(
                  child: Text(
                    'Vui lòng thoát khỏi khu vực và gọi cứu hỏa ngay lập tức!',
                    style: TextStyle(color: MpColors.red, fontWeight: FontWeight.w500),
                  ),
                ),
              ],
            ),
